...
function Home() {
    return (
        <main className="md:ml-[16.6667%] p-5 md:pr-0">
            ...
            <section className=" py-10 mx-5">
                ...
                <div className="mt-8 flex  items-center justify-center gap-4">
                    ...
                    <div className="flex items-center gap-2">
                        <FaMapMarkerAlt className="text-blue-500 text-lg align-middle"/>
                    ...
                    {/* Bouton About */}
                    <button
                        className=" flex items-center gap-2 border rounded-xl px-4 py-2 hover:bg-slate-700 hover:text-blue-500 hover:border-transparent transition duration-200">
            ...
            <section className="pb-10 mx-5 ">
                ...
                <div className="flex-grow  border-t-2 border-dashed border-slate-400 mt-8"></div>
